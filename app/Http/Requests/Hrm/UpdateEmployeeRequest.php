...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['nullable', 'string','min:1', 'max:11', new UniqueInDatabase('employees', 'code', 'mysql', $this->route('employee'))],
            'fingerprint_code' => ['nullable', 'string', 'max:100', new UniqueInDatabase('employees', 'fingerprint_code', 'mysql', $this->route('employee'))],
            'skype_id' => ['nullable', 'string', 'max:100', new UniqueInDatabase('employees', 'skype_id', 'mysql', $this->route('employee'))],
            'user_id' => ['nullable', 'integer', new UniqueInDatabase('employees', 'user_id', 'mysql', $this->route('employee'))],
            'old_identity_card_number' => ['nullable', 'string', 'max:20', new UniqueInDatabase('employees', 'old_identity_card_number', 'mysql', $this->route('employee'))],
            'identity_card_number' => ['required', 'string', 'max:20', new UniqueInDatabase('employees', 'identity_card_number', 'mysql', $this->route('employee'))],
            'tax_code' => ['nullable', 'string', 'max:20', new UniqueInDatabase('employees', 'tax_code', 'mysql',$this->route('employee'))],
            'social_insurance_number' => ['nullable', 'string', 'max:20', new UniqueInDatabase('employees', 'social_insurance_number', 'mysql', $this->route('employee'))],
            'bank_account_number' => ['nullable', 'string', 'max:20', new UniqueInDatabase('employees', 'bank_account_number', 'mysql', $this->route('employee'))],
