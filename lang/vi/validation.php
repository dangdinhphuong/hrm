...
return [
    ...
    | lớp validator. Một số quy tắc này có nhiều phiên bản như
    | quy tắc kích thước. Bạn có thể thay đổi từng thông báo ở đây.
    |
    */
    ...
    'between' => [
        ...
        'file' => 'Trường :attribute phải nằm trong khoảng từ :min đến :max kilobytes.',
    ...
    'doesnt_end_with' => 'Trường :attribute phải không kết thúc bằng một trong những giá trị sau: :values.',
    'doesnt_start_with' => 'Trường :attribute phải không bắt đầu bằng một trong những giá trị sau: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Trường :attribute đã chọn đã xuất hiện trong một sự cố dữ liệu. Vui lòng chọn một :attribute khác.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Ngôn ngữ Dịch Thông Báo Tùy Chỉnh
    |--------------------------------------------------------------------------
    |
    | Ở đây, bạn có thể chỉ định các thông báo tùy chỉnh cho các thuộc tính sử dụng
    | quy tắc "attribute.rule" để đặt tên các dòng ngôn ngữ. Điều này giúp chúng ta
    | chỉ định nhanh chóng một dòng ngôn ngữ tùy chỉnh cụ thể cho một quy tắc thuộc tính đã cho.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Thuộc Tính Dịch Ngôn Ngữ Thông Báo Tùy Chỉnh
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ dưới đây được sử dụng để hoán đổi các vị trí của thuộc tính chứa
    | những gì đó thân thiện hơn với người đọc như "Địa chỉ E-Mail" thay vì "email".
    | Điều này giúp chúng ta làm cho thông điệp của mình trở nên rõ ràng hơn.
    |
    */
